...
export const pokemons: Pokemon[] = [
  {
    ...
    counters: [PokemonType.fire, PokemonType.psychic, PokemonType.flying, PokemonType.ice],
    moves: [
    ...
    evolution: { pre: [], pos: ['2'] },
    animations: [
      { url: 'animation/001-bulbasaur-normal.gif', status: PokemonStatus.normal },
      { url: 'animation/001-bulbasaur-attacking.gif', status: PokemonStatus.attacking },
      { url: 'animation/001-bulbasaur-roaring.gif', status: PokemonStatus.roaring },
    ],
    voices: [{ url: 'voice/001-bulbasaur-normal.wav', status: PokemonStatus.normal }],
  },
  {
    id: '2',
    name: 'Ivysaur',
    ...
    counters: [PokemonType.fire, PokemonType.psychic, PokemonType.flying, PokemonType.ice],
    moves: [
      { name: 'Vine Whip', damage: 7, type: PokemonType.normal },
      { name: 'Razor Leaf', damage: 13, type: PokemonType.normal },
      { name: 'Sludge Bomb', damage: 80, type: PokemonType.poison },
    ...
    animations: [
      ...
      { url: 'animation/001-ivysaur-attacking.gif', status: PokemonStatus.attacking },
      { url: 'animation/001-ivysaur-roaring.gif', status: PokemonStatus.roaring },
    ],
    voices: [{ url: 'voice/001-ivysaur-normal.wav', status: PokemonStatus.normal }],
  },
];
